import { CalendarDays, CloudDrizzle, CloudRain, CloudSun, Cloudy, Command, Droplets, Eye, Gauge, Github, Navigation, Search, Snowflake, Sun, Sunset, Thermometer, ThermometerSun, UserRound, Wind } from "lucide-react";
...
export const thermometr = <Thermometer size={15} />
